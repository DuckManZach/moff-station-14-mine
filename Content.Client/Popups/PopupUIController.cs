...
public sealed class PopupUIController : UIController, IOnStateEntered<GameplayState>, IOnStateExited<GameplayState>
{
    ...
    public override void Initialize()
    {
        ...
        _smallFont = new VectorFont(cache.GetResource<FontResource>("/Fonts/_Moffstation/JetBrainsMono/JetBrainsMono-Italic.ttf"), 10);
        _mediumFont = new VectorFont(cache.GetResource<FontResource>("/Fonts/_Moffstation/JetBrainsMono/JetBrainsMono-Italic.ttf"), 12);
        _largeFont = new VectorFont(cache.GetResource<FontResource>("/Fonts/_Moffstation/JetBrainsMono/JetBrainsMono-BoldItalic.ttf"), 14);
    }
